...
struct UserGuidePDFGenerator {
    ...
    func generate() -> Data {
        ...
        return renderer.pdfData { context in
            ...
            y += 24
            y = drawCentered("A project and task management app for iPhone and iPad.", at: y, font: .systemFont(ofSize: 14), color: .secondaryLabel)
            ...
            y += 4
            y = drawBody("The app has four main tabs at the bottom of the screen:", at: y)
            y += 6
            let tabs = [
            ...
            y += 20
            space(100)
            y = drawHeading("16. Tips & Tricks", at: y)
            y += 4
            let tips = [
